  ...
  renderParagraph(linkURL, linkName) {
    ...
    if (linkName == 'Home') {
      ...
      this.fillerTextSentences.push(
        ...
        '<div tabindex="0"><p>The Wright Brothers &amp; The Invention of the Aerial Age</p></div>',
      ...
      this.fillerTextSentences.push(
        ...
        '<div tabindex="0"><h3>Key objects:</h3><ul><li><a href="#home" onclick="return goToObject(`object_01`)">A Rare Wright Bicycle</a></li></ul></div>',
      ...
      this.fillerTextSentences.push(
        '<figure id=”stop_06">',
        '<div tabindex="0"><img style="width:100%" src="stops/stop_06.jpg" alt="ALT_DESCRIPTION_GOES_HERE"></div>',
      ...
      this.fillerTextSentences.push(
        '<figure id=”stop_07">',
        '<div tabindex="0"><img style="width:100%" src="stops/stop_07.jpg" alt="ALT_DESCRIPTION_GOES_HERE"></div>',
      ...
      this.fillerTextSentences.push(
        '<figure id=”stop_08">',
        '<div tabindex="0"><img style="width:100%" src="stops/stop_08.jpg" alt="ALT_DESCRIPTION_GOES_HERE"></div>',
        ...
        '<div tabindex="0"><h3>Key objects:</h3><ul><li><a href="#home" onclick="return goToObject(`object_05`)">1903 Wright Flyer</a></li><li><a href="#home" onclick="return goToObject(`object_08`)">Stopwatch</a></li><li><a href="#home" onclick="return goToObject(`object_09`)">Telegraph Key</a></li></ul></div>',
      ...
      this.fillerTextSentences.push(
        '<figure id=”stop_11">',
        '<div tabindex="0"><img style="width:100%" src="stops/stop_11.jpg" alt="ALT_DESCRIPTION_GOES_HERE"></div>',
      ...
      this.fillerTextSentences.push(
        '<figure id=”stop_12">',
        '<div tabindex="0"><img style="width:100%" src="stops/stop_12.jpg" alt="ALT_DESCRIPTION_GOES_HERE"></div>',
    ...
    } else if (linkName == 'Wright Bicycle') {
      this.fillerTextSentences.push(
        '<figure id=”object_01">',
      ...
      this.fillerTextSentences.push(
        ...
        '<div tabindex="0"><p><strong>Wingspan:</strong> 17 ft (5.2 m)</p></div>',
        '<div tabindex="0"><p><strong>Wing area:</strong> 165 sq ft (15 sq m)</p></div>',
        '<div tabindex="0"><p><strong>Length:</strong> 11 ft 2 in (3.4 m)</p></div>',
        '<div tabindex="0"><p><strong>Height:</strong> 4 ft 3 in (1.3 m)</p></div>',
      ...
      this.fillerTextSentences.push(
        ...
        '<div tabindex="0"><p>1900 Wright Glider (reproduction)</p></div>',
        '<div tabindex="0"><p>The 1900 glider was the Wrights’ first piloted aircraft, flight tested at Kitty Hawk that fall. It incorporated the wire-braced biplane structure and wing-warping control system they developed with their 1899 kite.</p></div>',
        '<div tabindex="0"><p>The glider generated far less lift than the brothers’ calculations had predicted. However, the control systems—wing warping for lateral control and forward elevator for pitch control—worked beautifully. While the Wrights managed only two minutes of free gliding in 1900, those precious seconds in the air proved their innovative control ideas were sound.</p></div>',
        '<div tabindex="0"><p><i>Gift of Ken Hyde, The Wright Experience, Warrenton, VA</i></p></div>',
      ...
      this.fillerTextSentences.push(
        ...
        '<div tabindex="0"><p>Stopwatch, Wright brothers</p></div>',
      ...
      this.fillerTextSentences.push(
        ...
        '<div tabindex="0"><p>Telegraph key, Wright 1903 flight</p></div>',
      ...
      this.fillerTextSentences.push(
        ...
        '<div tabindex="0"><p>Wright Vertical Four-Cylinder Engine</div>',
